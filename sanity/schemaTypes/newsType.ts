...
export default defineType({
    ...
    fields: [
        ...
        defineField({name: 'reporters', title: 'Reporters', type: 'array', of: [{type: 'reference', to: {type: 'reporter'}}], validation: (Rule: Rule) => Rule.required().min(1)}),
        ...
        defineField({name: 'category', title: 'Category', type: 'string', options: {list: ["Industry", "Hardware", "Updates", "Esports"], layout: 'radio'}, validation: (Rule: Rule) => Rule.required()}),
