...
defineField({name: 'releaseDate', title: 'Release Date', type: 'date', validation: (Rule: Rule) => Rule.required()}),
...
defineField({name: 'synopsis', title: 'Synopsis', type: 'text', validation: (Rule: Rule) => Rule.required()}),
