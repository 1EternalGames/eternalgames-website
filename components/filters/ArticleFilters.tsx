    ...
    const desktopFilters = (
        <div className={styles.desktopFilters}>
            ...
            <FilterGroup label="التصفية بـ:">
                ...
                <AnimatePresence>{hasActiveFilters && (<motion.button className={`${styles.filterButton} ${styles.clear}`} onClick={onClearAllFilters} initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.8 }}> مسح المرشحات </motion.button>)}</AnimatePresence>
            </FilterGroup>
        </div>
    );
             ...
             <AnimatePresence>
                {isMobileFiltersOpen && (
                    ...
                    >
                        ...
                        {hasActiveFilters && (<motion.button className={`${styles.filterButton} ${styles.clear}`} onClick={onClearAllFilters}> مسح المرشحات </motion.button>)}
                    </motion.div>
                )}
            </AnimatePresence>
        </>
