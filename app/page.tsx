...
// const getCachedEnrichedCreators = ...
...
export default async function HomePage() {
    ...
    // REMOVED: Unnecessary enrichment call. Data now comes directly from Sanity.
    ...
    return (
        <DigitalAtriumHomePage 
            reviews={reviews} // MODIFIED: Pass the original 'reviews' data
